...
theme.wallpaper                                 = theme.dir .. "/wallhaven-zme9mw.png"
...
function theme.at_screen_connect(s)
	...
	awful.spawn.with_shell("feh --bg-fill ~/.config/awesome/themes/powerarrow-dark/wallhaven-zme9mw.png")
    -- Tags
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           --arrl_ld,
            ...
            --wibox.container.background(.widget, theme.bg_focus),
